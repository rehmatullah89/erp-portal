<?
	...
	***********************************************************************************************
	...
	$sSQL = "SELECT id FROM tbl_compliance_questions WHERE id='$Id'";
	$objDb->query($sSQL);
	...
	if ($Category > 0)
	{
		$sSQL = "SELECT title FROM tbl_compliance_categories WHERE id='$Category'";
		$objDb->query($sSQL);
	...
	$sSQL  = "SELECT * FROM tbl_compliance_questions WHERE title LIKE '$Title' AND category_id='$Category' AND id!='$Id'";

	if ($objDb->query($sSQL) == true)
	{
		if ($objDb->getCount( ) == 0)
		{
			$sSQL = "UPDATE tbl_compliance_questions SET category_id='$Category', title='$Title', details='$Details' WHERE id='$Id'";
