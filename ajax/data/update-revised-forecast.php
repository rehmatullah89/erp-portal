<?
	...
	***********************************************************************************************
	...
	$sSQL = "SELECT id FROM tbl_revised_forecasts WHERE id='$Id'";
	$objDb->query($sSQL);
	...
	$sSQL = "UPDATE tbl_revised_forecasts SET month='$Month', year='$Year', country_id='$Region', vendor_id='$Vendor', brand_id='$Brand', season_id='$Season', style_id='$StyleNo', quantity='$Quantity' WHERE id='$Id'";
