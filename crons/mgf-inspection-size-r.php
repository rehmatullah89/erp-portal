<?
	...
	***********************************************************************************************
	...
	$sExcelFile = ($sBaseDir."mgf/test2/INSPECTION_AUDIT_SIZE.xlsx");
	...
	$sSQL = "SELECT user_id, audit_code, created_at, vendor_id,
                    (SELECT GROUP_CONCAT(size SEPARATOR ', ') FROM tbl_sizes WHERE FIND_IN_SET(id, tbl_qa_reports.sizes)) AS _Sizes
			 FROM tbl_qa_reports
	...
	for ($i = 0; $i < $iCount; $i ++)
	{
		...
		$sSizes     = $objDb->getField($i, "_Sizes");
