<?
	...
	***********************************************************************************************
	...
	$sExcelFile = ($sBaseDir."mgf/{$sDir}INSPECTION_DEFECT.xlsx");
	...
	$sSQL = "SELECT qr.user_id, qr.audit_code, qr.created_at, qr.date_time, qr.audit_date, qr.created_by, qr.vendor_id, qr.modified_by,
		...
		WHERE qr.id=qrd.audit_id AND qr.report_id IN ($sReports) AND ((DATE(qr.created_at) BETWEEN '$sFromDate' AND '$sToDate') OR (DATE(qr.date_time) BETWEEN '$sFromDate' AND '$sToDate'))
