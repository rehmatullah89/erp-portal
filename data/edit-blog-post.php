<?
	...
	***********************************************************************************************
	...
	$sSQL = "SELECT * FROM tbl_blog WHERE id='$Id'";
	$objDb->query($sSQL);
...
?>
  <script type="text/javascript" src="scripts/data/edit-blog-post.js"></script>
...
<!--  Body Section Starts Here  -->
	    <div id="Body">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr valign="top">
			  <td width="100%">
			    <h1><img src="images/h1/data/blog-entry-form.jpg" width="234" height="20" vspace="10" alt="" title="" /></h1>

			    <form name="frmData" id="frmData" method="post" action="data/update-blog-post.php" enctype="multipart/form-data" class="frmOutline" onsubmit="$('BtnSave').disable( );">
			    ...
			    <table width="98%" cellspacing="0" cellpadding="4" border="0" align="center">
				  <tr>
				    ...
				    <td><input type="text" name="Title" value="<?= $sTitle ?>" size="50" maxlength="255" class="textbox" /></td>
				  </tr>
...
?>
		            	<option value="<?= $iKey ?>"<?= (($iCategory == $iKey) ? " selected" : "") ?>><?= $sValue ?></option>
<?
	}
?>
					  </select>
				  ...
				  <tr>
				    ...
				    <td>
					  <input type="file" name="Picture" size="25" class="textbox" />
<?
	if ($sPicture != "" && @file_exists($sBaseDir.BLOG_IMG_PATH.'originals/'.$sPicture))
	{
?>
                      &nbsp; ( <a href="<?= BLOG_IMG_PATH.'originals/'.$sPicture ?>" class="lightview" title="<?= $sName ?>">view</a> )
<?
	}
?>
					</td>
			    ...
			    <table width="100%" cellspacing="0" cellpadding="5" border="0">
				  <tr>
				    <td width="100%"><textarea name="Post" id="Post" style="width:100%; height:400px;"><?= $sPost ?></textarea></td>
				  </tr>
				</table>
