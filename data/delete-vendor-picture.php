<?
	...
	***********************************************************************************************
	...
	$sSQL  = "SELECT picture FROM tbl_vendor_profile_pictures WHERE id='$Id'";
	...
	if ($bFlag == true && $objDb->getCount( ) == 1)
	{
		...
		$sSQL = "DELETE FROM tbl_vendor_profile_pictures WHERE id='$Id'";
	...
	if ($bFlag == true)
	{
		...
		$_SESSION['Flag'] = "VENDOR_ALBUM_PIC_DELETED";
	}
