<?
	...
	while (($sRecord = @fgetcsv($hFile, 10000)) !== FALSE)
	{
		if ($sRecord[0] == "PC5 Code" && $sRecord[1] == "Product Name")
		{
			...
			$iStyleId = getDbValue("id", "tbl_styles", "style LIKE '$sStyleNo' AND brand_id='$iBrand' AND sub_brand_id='$iSubBrand' AND season_id='$iSeason' AND sub_season_id='$iSubSeason'");
