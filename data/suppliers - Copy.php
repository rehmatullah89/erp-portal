<?
	...
	***********************************************************************************************
	...
	//	$sSuppliersList = getList("tbl_suppliers", "id", "supplier", "parent_id='0' AND id IN ({$_SESSION['Vendors']})");
?>
				...
				<table border="0" cellpadding="3" cellspacing="0" width="100%">
				  <tr valign="top">
					<td width="52%">
					  ...
					  <table border="0" cellpadding="3" cellspacing="0" width="100%">
					    <tr>
						  <td width="140">Sourcing Supplier</td>
...
?>
					    ...
					    <tr>
						  <td>Supplier<span class="mandatory">*</span></td>
						  <td align="center">:</td>
...
?>
						  ...
						  <td width="48%">
						    ...
						    <table border="0" cellpadding="3" cellspacing="0" width="100%">
							  ...
							  <tr>
							    <td colspan="3">* <a href="data/google-latlong.php?Lat=Latitude<?= $iId ?>&Lon=Longitude<?= $iId ?>" class="lightview" rel="iframe" title="Supplier Latitude/Longitude :: :: width:780, height:561">Find Latitude/Longitude</a></td>
							  </tr>
