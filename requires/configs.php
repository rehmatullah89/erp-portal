<?
	...
	***********************************************************************************************
	...
	define('PACKAGING_PICS_DIR', 'files/packaging/');
        define('SIGNATURES_PICS_DIR', 'files/qa-signatures/');
	...
	// Auditor App Icons Dir
	define("AUDITOR_APP_ICONS_DIR", "files/quonda/auditor-app-icons/");
	...
	define('SAMPLING_SPECS_SHEETS_DIR', 'files/sampling-specs-sheet/');
        define('CARTONS_PICS_DIR',    'files/qa-cartons');
	...
	$iQmipReports = array(15,16,17,18,21,22,41);
