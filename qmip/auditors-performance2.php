...
<!--  Body Section Starts Here  -->
	    <div id="Body">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr valign="top">
			  <td width="100%">
			    <h1><img src="images/h1/qmip/auditor-perf.jpg" height="23" alt="" title="" style="margin:9px 0px 8px 0px;" /></h1>
            ...
            <div class="content-area">
			 ...
			 GROUP BY qa.user_id Order By CountAudits DESC";
                       ...
                       //Initialize <chart> element
                        $strXML = "<chart caption='Auditors Performance' numberPrefix='' showValues='0' showSum='1' formatNumberScale='0' labelDisplay='ROTATE'>";
                        ...
                        echo renderChart("scripts/fusion-charts/charts/StackedColumn3D.swf", "", $strXML, "auditorsPerformance", 900, 450, false, false);
