...
?>
  <script type="text/javascript" src="scripts/qmip/send-qa-report.js"></script>
</head>
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr valign="top">
			  <td width="100%">
			    ...
			    <form name="frmData" id="frmData" method="post" action="qmip/email-qa-report.php" class="frmOutline" onsubmit="$('BtnSubmit').disabled=true;">
