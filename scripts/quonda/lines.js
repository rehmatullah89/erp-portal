...
function validateForm( )
{
	...
	if (!objFV.validate("Line", "B", "Please enter the Line."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/quonda/update-line.php";
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout(
					...
					new Effect.SlideUp("Msg" + iId);
						...
						$('Line_' + iId).innerHTML   = sParams[3];
						$('Vendor_' + iId).innerHTML = sParams[4];
						$('Unit_' + iId).innerHTML   = sParams[5];
						$('Floor_' + iId).innerHTML  = sParams[6];
						$('Type_' + iId).innerHTML   = sParams[7];
				    },
