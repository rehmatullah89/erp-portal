...
function validateForm( )
{
	...
	if (!objFV.validate("Report", "B", "Please enter the Report Type."))
		return false;

	if (!objFV.validate("Code", "B", "Please enter the Report Code."))
		return false;

	if (!objFV.validate("Failure", "F", "Please enter the valid Failure DR."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/quonda/update-report.php";
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout(
				    function( )
				    {
						...
						$('Failure' + iId).innerHTML = sParams[6];
				    },
