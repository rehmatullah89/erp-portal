...
function validateForm( )
{
	...
	if (!objFV.validate("AuditStage", "B", "Please select the Audit Stage."))
        ...
        if (objFV.value("Report") == "14" || objFV.value("Report") == "34" || objFV.value("Report") == "47")
	{
               if (!objFV.validate("InspectionLevel", "B", "Please select the Inspection Level."))
                    return false;
                    
                if (!objFV.validate("AqlLevel", "B", "Please select the AQL Level."))
                    return false;    
	...
	if (objFV.value("Report") != "14" && objFV.value("Report") != "34" && objFV.value("Report") != "47" && objFV.value("Report") != "28" && objFV.value("Report") != "37" && objFV.value("Report") != "38" && objFV.value("Report") != "39" && objFV.value("Report") != "44" && objFV.value("Report") != "45" && objFV.value("Vendor") != "229")
	{
	...
	if (objFV.value("Report") != "26")
	{
        ...
        if (objFV.value("Report") != "26" && objFV.value("Report") != "28" && objFV.value("Report") != "37" && objFV.value("Report") != "38")
	{
            try{
...
function validateEditForm(iId)
{
	...
	if (objFV.value("Report") != "14" && objFV.value("Report") != "34" && objFV.value("Report") != "47" && objFV.value("Report") != "28" && objFV.value("Report") != "37" && objFV.value("Report") != "38" && objFV.value("Report") != "39" && objFV.value("Vendor") != "229" && objFV.value("Report") != "44" && objFV.value("Report") != "45" && objFV.value("Report") != "46")
	{
		if (!objFV.validate("Line", "B", "Please select the Vendor Line."))
			return false;
