...
function validateForm( )
{
	...
	if (!objFV.validate("DefectType", "B", "Please enter the Defect Type."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/quonda/update-defect-type.php"; 
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
				    ...
				    { 			
						...
						$('DefectType' + iId).innerHTML   = sParams[3];
						$('Color' + iId).style.background = sParams[4];
				    },				    
