...
*/
            ...
            leftPanel: function (element) {
                ...
                var ganttLeftPanel = $('<div class="leftPanel"/>')
                    .append($('<div class="row spacer"><div style="height:48px;"></div><div class="row name"><span class="fn-label">PO #</span></div><div class="row desc"><span class="fn-label"><b>D # / Style #</b></span></div></div>')
                ...
                switch (settings.scale) {
                    ...
                    case "hours":
                        ...
                        for (var i = 0; i < range.length; i++) {
                            ...
                            if (rm !== month) {
                                monthArr.push(
                                    ('<div class="row header month calMonthEn" id="M' + month + 'Y' + rday.getFullYear() + '"  year="' + rday.getFullYear() + '" month="' + (month + 1) + '" style="width: '
                    ...
                    case "weeks":
                        ...
                        for (var i = 0; i < range.length; i++) {
                            ...
                            if (rday.getMonth() !== month) {
                                monthArr.push(
                                    ('<div class="row header month calMonthEn" year="' + rday.getFullYear() + '" month="' + (month + 1) + '" style="width:'
                                       + tools.getCellSize() * daysInMonth
                                       + 'px;" id="M' + month + 'Y' + rday.getFullYear() + '"><div class="fn-label">'
                                       + settings.months[month]
                                       + '</div></div>'));
                                month = rday.getMonth();
                                daysInMonth = 0;
                            ...
                            // Fill weeks
                            dayArr.push('<div class="row day wd calWeek" '
                    ...
                    case 'months':
                        ...
                        for (var i = 0; i < range.length; i++) {
                            ...
                            daysInYear++;
                            monthArr.push('<div class="row day wd calMonth" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.genRepDate() + '">' + (1 + rday.getMonth()) + '</div>');
                        }
                    ...
                    default:
                        ...
                        for (var i = 0; i < range.length; i++) {
                            ...
                            dayArr.push('<div class="row date calDay ' + day_class + '"  year="' + rday.getFullYear() + '" month="' + (rday.getMonth() + 1) + '" day="' + rday.getDate() + '" '
