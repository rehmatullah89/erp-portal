...
function validateForm( )
{
	...
	if (!objFV.validate("Code", "B", "Please enter the Color Code."))
		return false;

	if (!objFV.validate("Color", "B", "Please enter the Color Name."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/sampling/update-lab-dip-color.php"; 
