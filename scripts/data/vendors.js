...
function validateForm( )
{
	...
	if (!objFV.validate("Vendor", "B", "Please enter the Vendor."))
		return false;
	...
	if (!objFV.validate("DailyCapacity", "B,F", "Please enter the Daily Capacity."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/data/update-vendor.php"; 
