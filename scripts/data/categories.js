...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/data/update-category.php"; 
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
					...
					$('LeadTime1000Pcs' + iId).innerHTML = sParams[4];
					$('LeadTime2500Pcs' + iId).innerHTML = sParams[5];
					$('LeadTime5000Pcs' + iId).innerHTML = sParams[6];
				    },				    
