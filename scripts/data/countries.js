...
function validateForm( )
{
	...
	if (!objFV.validate("Country", "B", "Please enter the Country Name."))
		return false;
        
        if (!objFV.validate("Hours", "B", "Please enter the Hours Difference."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/data/update-country.php"; 
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
					...
					$('Country' + iId).innerHTML = sParams[3];
					$('Hours' + iId).innerHTML   = sParams[4];
				    },				    
