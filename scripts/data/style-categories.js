...
function validateForm( )
{
	...
	if (!objFV.validate("Category", "B", "Please enter the Style Category."))
		return false;

	if ($('Stages').selectedIndex == -1)
	{
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/data/update-style-category.php";
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout(
						function( )
						{
							...
							$('Category_' + iId).innerHTML = sParams[3];
							$('Stages_' + iId).innerHTML = sParams[4];
						},
