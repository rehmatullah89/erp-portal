...
function validateForm( )
{
	...
	if (!objFV.validate("UsCotton", "B,F", "Please enter the US Cotton Rate."))
		return false;

	if (!objFV.validate("PakCotton", "B,F", "Please enter the Pak Cotton Rate."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/data/update-cotton-rate.php";
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout(
				    function( )
				    {
						...
						$('UsCotton' + iId).innerHTML = sParams[3];
						$('PakCotton' + iId).innerHTML = sParams[4];
						},
