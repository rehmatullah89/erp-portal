...
function validateForm( )
{
	...
	if (!objFV.validate("Customer", "B", "Please enter the Customer."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/data/update-customer.php"; 
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
					...
					$('Customer' + iId).innerHTML   = sParams[3];
					$('Brand' + iId).innerHTML      = sParams[4];
					$('Details' + iId).innerHTML    = sParams[5];
				    },				    
