...
function validateForm( )
{
	...
	if (!objFV.validate("Title", "B", "Please enter the Stage Title."))
		return false;

	if (!objFV.validate("Type", "B", "Please select the Progress Type."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/data/update-production-stage.php";
