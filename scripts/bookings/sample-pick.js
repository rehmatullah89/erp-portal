...
function validateForm( )
{
	...
	if (!objFV.validate("SamplePick", "B", "Please enter the Sample Pick."))
		return false;
            
        if (!objFV.validate("Status", "B", "Please Select a Status."))
		return false;    
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/bookings/update-sample-pick.php";
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout(
					...
					$('SamplePick' + iId).innerHTML   = sParams[3];
                                        $('Status' + iId).innerHTML   = sParams[4];
				    },
