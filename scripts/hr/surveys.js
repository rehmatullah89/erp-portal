...
function validateForm( )
{
	...
	{
		alert("Please select atleat One Employee.");
...
function validateEditForm(iId)
{
	...
	if ($('Employees' + iId).selectedIndex == -1)
	{
		alert("Please select atleat One Employee.");
	...
	var sUrl    = "ajax/hr/update-survey.php"; 
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
					...
					$('Title' + iId).innerHTML     = sParams[3];
					$('FromDate_' + iId).innerHTML = sParams[4];
					$('ToDate_' + iId).innerHTML   = sParams[5];
					$('Employees' + iId).innerHTML = sParams[6];
				    },				    
