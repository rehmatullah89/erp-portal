...
//	if (!objFV.validate(("Employee" + iId), "B", "Please select the Employee."))
//		return false;
	...
	var sUrl    = "ajax/hr/update-calendar-entry.php"; 
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
					...
					$('Employee' + iId).innerHTML = sParams[3];
					$('Title' + iId).innerHTML    = sParams[4];
					$('Dates' + iId).innerHTML    = sParams[5];
				    },				    
