...
function validateForm( )
{
	...
	if (!objFV.validate("Salary", "B,N", "Please enter the Salary."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/hr/update-salary.php"; 
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
					...
					$('Year' + iId).innerHTML     = sParams[3];
					$('Month' + iId).innerHTML    = sParams[4];
					$('Salary' + iId).innerHTML   = sParams[5];
					$('Comments' + iId).innerHTML = sParams[6];
				    },				    
