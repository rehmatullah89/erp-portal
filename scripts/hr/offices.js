...
function validateForm( )
{
	...
	if (!objFV.validate("Office", "B", "Please enter the Office."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/hr/update-office.php"; 
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
					...
					$('Office' + iId).innerHTML  = sParams[3];
					$('Phone' + iId).innerHTML   = sParams[4];
					$('Fax' + iId).innerHTML     = sParams[5];
					$('Address' + iId).innerHTML = sParams[6];
					$('Country' + iId).innerHTML = sParams[7];
				    },				    
