...
function validateForm( )
{
	...
	if (!objFV.validate("Name", "B", "Please enter the Project Name."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/pcc/update-project.php";
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout(
				    function( )
				    {
						...
						$('Name' + iId).innerHTML        = sParams[3];
						$('Company' + iId).innerHTML     = sParams[4];
						$('Description' + iId).innerHTML = sParams[5];
				    },
