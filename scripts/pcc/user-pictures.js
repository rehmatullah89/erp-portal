...
function validateForm( )
{
	...
	if (!objFV.validate("Gallery", "B", "Please select the Picture Gallery."))
		return false;

	for (var i = 1; i <= 5; i ++)
	{
		if (objFV.value("Title" + i) != "" || objFV.value("Picture" + i) != "")
		{
			if (!objFV.validate(("Title" + i), "B", "Please enter the Picture Title."))
				return false;
