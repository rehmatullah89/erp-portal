...
function validateForm( )
{
	...
	if (!objFV.validate("Embellishment", "B", "Please enter the Embellishment."))
		return false;
	
	if (!objFV.validate("Type", "B", "Please select the Type."))
		return false;	
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/pcc/update-embellishment.php"; 
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
					...
					$('Embellishment' + iId).innerHTML = sParams[3];
