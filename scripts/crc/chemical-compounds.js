...
function validateForm( )
{
	...
	if (!objFV.validate("Type", "B", "Please Select the Chemical Type."))
		return false;

	if (!objFV.validate("Compound", "B", "Please enter the Compound Name."))
		return false;

	if (!objFV.validate("CasNo", "B", "Please enter the CAS No."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/crc/update-chemical-compound.php"; 
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
				    ...
				    { 			
						...
						$('Compound' + iId).innerHTML = sParams[3];
						$('CasNo' + iId).innerHTML    = sParams[4];
						$('Type' + iId).innerHTML     = sParams[5];						
				    },				    
