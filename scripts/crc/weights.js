...
function validateForm( )
{
	...
	if (!objFV.validate("Minimum", "B", "Please select the Minimum Weight."))
		return false;
		
	if (!objFV.validate("Maximum", "B", "Please select the Maximum Weight."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/crc/update-weight.php"; 
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout( 
					...
					$('Minimum' + iId).innerHTML = sParams[3];
					$('Maximum' + iId).innerHTML = sParams[4];
				    },				    
