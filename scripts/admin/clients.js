...
function validateForm( )
{
	...
	if (!objFV.validate("Client", "B", "Please enter the Client."))
		return false;

        if (!objFV.validate("Code", "B", "Please enter the Uniqe Client Code."))
		return false;         

	if (!objFV.validate("UserType[]", "B", "Please enter the User Type."))
		return false;
...
function validateEditForm(iId)
{
	...
	var sUrl    = "ajax/admin/update-client.php";
	...
	if (sResponse.status == 200 && sResponse.statusText == "OK")
	{
		...
		if (sParams[0] == "OK")
		{
			...
			setTimeout(
					...
					$('Client' + iId).innerHTML   = sParams[3];
                                        $('Code' + iId).innerHTML   = sParams[4];
                                        $('UserType' + iId).innerHTML   = sParams[5];
				    },
