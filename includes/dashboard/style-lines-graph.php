<?
	...
	***********************************************************************************************
	...
	$sSQL = "SELECT cutting_dr, final_dr, output_dr, batch_dr FROM tbl_vendors WHERE id='$Vendor'";
	$objDb->query($sSQL);
...
?>
						<div id="VendorLinesChart<?= $iUnit ?><?= $iShift ?>">loading...</div>

						<script type="text/javascript">
						<!--
						var objChart = new FusionCharts("scripts/fusion-charts/charts/Column3D.swf", "VendorLines<?= $iUnit ?><?= $iShift ?>", "100%", "<?= (($iShift == 0) ? 340 : 420) ?>", "0", "1");
...
?>
						...
						objChart.render("VendorLinesChart<?= $iUnit ?><?= $iShift ?>");
						-->
						</script>
