	...
	if ($_SESSION['Flag'] != "")
	{
		$sMessages = array(
						    ...
						    'DATA_SAVED'                           => 'The selected Form Data has been Saved succesfully.',
                                                    ...
                                                    'PUBLISH_STATUS_ERROR'                 => 'The selected report can not be publised due to Audit Result on Hold.',
						    ...
						    'ACCOUNT_DELETED'                      => 'Your Account has been Deleted by the Website Administrator.',
                                                    ...
                                                    'OLD_PASSWORD_CHANGE_ERROR'            => 'Please choose a new password, New password can not be same as old password!',
                                                    ...
                                                    'SAMPLE_SPECS_DELETED'                 => 'The specified Sample Specs have been Deleted successfully.',
                                                    'SECTION_UPDATED'                      => 'The specified section has been updated into the System successfully.',
                                                    ...
                                                    'BOOKING_UPDATED'                        => 'The specified Booking Request has been Updated successfully.',
                                                    'BOOKING_ADDED'                      => 'The specified Booking Request has been Added into the System successfully.',
                                                    'BOOKING_DELETED'                      => 'The specified Booking has been Deleted from System successfully.',
                                                    'PORT_ADDED'                           => 'The specified Shipping Port has been Added into the System successfully.',
                                                    'PORT_EXISTS'                          => 'The specified Shipping Port already exists in the System.', 
                                                    'PORT_DELETED'                         => 'The specified Shipping Port has been Deleted from System successfully.',
						    ...
						    'OFFICE_DELETED'                       => 'The selected Office has been Deleted from the System successfully.',
                                                    ...
                                                    'SGT_INSPECTION_ADDED'                     => 'The specified Sgt Inspection record has been Added into the System successfully.',
						    'SGT_INSPECTION_EXISTS'                    => 'The specified Sgt Inspection record already exists in the System.',
						    'SGT_INSPECTION_DELETED'                   => 'The selected Sgt Inspection has been Deleted from the System successfully.',
						    ...
						    'VENDOR_ADDED'                         => 'The specified Vendor has been Added into the System successfully.',
                                                    'VENDOR_UPDATED'                       => 'The specified Vendors Information has been Updated successfully.',
						    ...
						    'SUPPLIER_EXISTS'                        => 'The specified Supplier / Code / Country already exists in the System.',
						    'SUPPLIER_DELETED'                       => 'The selected Supplier has been Deleted from the System successfully.',
						    ...
						    'PO_STATUS_UPDATED'                    => 'The Status of selected Purchase Order(s) have been Updated successfully.',
                                                    'QA_STATUS_UPDATED'                    => 'The Status of selected QA Report has been Updated successfully.',
						    ...
						    'AUDIT_STAGE_POSITION_UPDATED'         => 'The Position of selected Audit Stage has been Updated successfully.',
                                                    ...
                                                    'AUDIT_SERVICE_ADDED'                    => 'The specified Audit Service has been Added into the System successfully.',
						    'AUDIT_SERVICE_EXISTS'                   => 'The specified Audit Service already exists in the System.',
						    'AUDIT_SERVICE_DELETED'                  => 'The selected Audit Service has been Deleted from the System successfully.',
						    'AUDIT_SERVICE_POSITION_UPDATED'         => 'The Position of selected Audit Service has been Updated successfully.',

                                                    'CLIENT_ADDED'                    => 'The specified Client has been Added into the System successfully.',
						    'CLIENT_EXISTS'                   => 'The specified Client already exists in the System.',
						    'CLIENT_DELETED'                  => 'The selected Client has been Deleted from the System successfully.',
						    'CLIENT_POSITION_UPDATED'         => 'The Position of selected Client has been Updated successfully.',

                    
                                                    'AUDIT_TYPE_ADDED'                    => 'The specified Audit Type has been Added into the System successfully.',
						    'AUDIT_TYPE_EXISTS'                   => 'The specified Audit Type already exists in the System.',
						    'AUDIT_TYPE_DELETED'                  => 'The selected Audit Type has been Deleted from the System successfully.',
						    'AUDIT_TYPE_POSITION_UPDATED'         => 'The Position of selected Audit Type has been Updated successfully.',

                                                    'STATEMENT_ADDED'                    => 'The specified Predefined Statement has been Added into the System successfully.',
						    'STATEMENT_EXISTS'                   => 'The specified Predefined Statement already exists in the System.',
						    'STATEMENT_DELETED'                  => 'The selected Predefined Statement has been Deleted from the System successfully.',
						    'STATEMENT_POSITION_UPDATED'         => 'The Position of selected Predefined Statement has been Updated successfully.',

                                                    'QUESTION_ADDED'                    => 'The specified Child Labor Question has been Added into the System successfully.',
						    'QUESTION_EXISTS'                   => 'The specified Child Labor Question already exists in the System.',
						    'QUESTION_DELETED'                  => 'The selected Child Labor Question has been Deleted from the System successfully.',
						    'QUESTION_POSITION_UPDATED'         => 'The Position of selected Child Labor Question has been Updated successfully.',

                                                    'SECTION_ADDED'                    => 'The specified Auditor App Section has been Added into the System successfully.',
						    'SECTION_EXISTS'                   => 'The specified Auditor App Section already exists in the System.',
						    'SECTION_DELETED'                  => 'The selected Auditor App Section has been Deleted from the System successfully.',
						    'SECTION_POSITION_UPDATED'         => 'The Position of selected Auditor App Section has been Updated successfully.',

                                                    'USER_TYPE_ADDED'                    => 'The specified User Type has been Added into the System successfully.',
						    'USER_TYPE_EXISTS'                   => 'The specified User Type already exists in the System.',
						    'USER_TYPE_DELETED'                  => 'The selected User Type has been Deleted from the System successfully.',
						    'USER_TYPE_POSITION_UPDATED'         => 'The Position of selected User Type has been Updated successfully.',
						    ...
						    'QA_EMAIL_SENT'                        => 'The selected QA Report has been Emailed successfully.',
                                                    'SAMPLING_EMAIL_SENT'                  => 'The selected Sampling Report has been Emailed successfully.',
						    ...
						    'DEPARTMENT_POSITION_UPDATED'          => 'The Position of selected Department has been Updated successfully.',
                                                    ...
                                                    'SAMPLE_PICK_ADDED'                     => 'The specified Sample Pick has been Added into the System successfully.',
						    'SAMPLE_PICK_EXISTS'                    => 'The specified Sample Pick already exists in the System.',
						    'SAMPLE_PICK_DELETED'                   => 'The selected Sample Pick has been Deleted from the System successfully.',
						    'SAMPLE_PICK_POSITION_UPDATED'          => 'The Position of selected Sample Pick has been Updated successfully.',

                                                    'PACKAGING_DEFECT_ADDED'                     => 'The Packaging Defect has been Added into the System successfully.',
						    'PACKAGING_DEFECT_EXISTS'                    => 'The Packaging Defect already exists in the System.',
						    'PACKAGING_DEFECT_DELETED'                   => 'The selected Packaging Defect has been Deleted from the System successfully.',
						    'PACKAGING_DEFECT_POSITION_UPDATED'          => 'The Position of selected Packaging Defect has been Updated successfully.',
							...
							'TNC_AUDIT_IMAGE_DELETED' 			   => 'The selected Audit Image has been deleted successfully.',
                                                        ...
                                                        'CRC_AUDIT_ADDED'                      => 'The specified CRC Audit has been Added into the System successfully.',
							'CRC_AUDIT_EXISTS'                     => 'The specified CRC Audit already exists in the System.',
							'CRC_AUDIT_UPDATED'    		           => 'The selected CRC Audit has been Updated successfully.',
                                                        'CRC_AUDIT_DELETED'                    => 'The selected CRC Audit has been Deleted from the System successfully.',
                ...
                'FACTORY_PARENT_ADDED'                 => 'The specified Parent has been Added into the System successfully.',
                'FACTORY_PARENT_DELETED'                      => 'The selected Parent has been Deleted from the System successfully.', 
                'JCREW_INVOICE_ADDED'                      => 'The selected J.Crew Invoice has been Added into the System successfully.',
                'JCREW_INVOICE_DELETED'                      => 'The selected J.Crew Invoice has been Deleted from the System successfully.', 
                'JCREW_INVOICE_PAYMENT_RECEIVED'                      => 'The selected J.Crew Invoice Payment has been Received successfully.',                                
						  );
