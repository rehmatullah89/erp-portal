<?
	...
	***********************************************************************************************
	...
	$sSQL = "SELECT user_id, alert_types
	         ...
	         WHERE trigger_id='5' AND (vendor_id='0' OR vendor_id='$iVendorId') AND (brand_id='0' OR brand_id='$iBrandId') AND status='A' AND user_id IN (SELECT id FROM tbl_users WHERE status='A' AND email_alerts='Y')";
	$objDb->query($sSQL);
