...
//error_reporting(E_ALL);
	...
	$iPageCount  = $objPdf->setSourceFile($sBaseDir."templates/hohenstein-p1.pdf");
	...
	$iPageCount  = $objPdf->setSourceFile($sBaseDir."templates/hohenstein-p2.pdf");
	$iTemplateId = $objPdf->importPage(1, '/MediaBox');
	...
	$iPageCount  = $objPdf->setSourceFile($sBaseDir."templates/hohenstein-p3.pdf");
	$iTemplateId = $objPdf->importPage(1, '/MediaBox');
	...
	$iCurrentPage = 4;
	$iPageCount   = $objPdf->setSourceFile($sBaseDir."templates/hohenstein-p4.pdf");
	$iTemplateId  = $objPdf->importPage(1, '/MediaBox');
...
//			$objPdf->Text(38, 52.2, $sQtyPerSize);
	...
	$iPageCount  = $objPdf->setSourceFile($sBaseDir."templates/hohenstein-annexure.pdf");
	$iTemplateId = $objPdf->importPage(1, '/MediaBox');
	...
	if (count($sDefects) > 0)
	{
		$iPageCount  = $objPdf->setSourceFile($sBaseDir."templates/hohenstein-page.pdf");
		$iTemplateId = $objPdf->importPage(1, '/MediaBox');
