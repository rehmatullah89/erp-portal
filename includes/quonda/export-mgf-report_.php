<?
	...
	***********************************************************************************************
	...
	$objPdf->SetXY(97.5, 40.8);
	$objPdf->write(0, $sStyle);

	$objPdf->SetXY(135.5, 40.8);
	$objPdf->write(0, formatNumber($iQuantity, false));

	$objPdf->SetXY(175, 40.8);
	...
	$objPdf->write(0, date('d-M-Y',strtotime($sEtdRequired)));
	...
	$objPdf->SetXY(51, 84.4);
	$objPdf->Cell(200, 0, $sCartonNo, 0, 0);
	...
	if ($sAuditResult == "P")
		$objPdf->Image(($sBaseDir.'images/icons/tick.gif'), 66.5, 237.8, 4);

	else if ($sAuditResult == "F")
		$objPdf->Image(($sBaseDir.'images/icons/tick.gif'), 106, 237.8, 4);

	else if ($sAuditResult == "H")
		$objPdf->Image(($sBaseDir.'images/icons/tick.gif'), 140, 237.8, 4); 
