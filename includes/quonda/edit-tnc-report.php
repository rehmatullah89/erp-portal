...
?>
			    ...
			    <table border="1" bordercolor="#ffffff" cellpadding="5" cellspacing="0" width="100%">
			      <tr class="sdRowHeader">
					...
					<td width="42" align="center" rowspan="2"><b>Width</b></td>
					<td width="42" align="center" rowspan="2"><b>Ticket Yards</b></td>
					<td width="42" align="center" rowspan="2"><b>Actual Yards</b></td>
					...
					<table border="1" bordercolor="#ffffff" cellpadding="5" cellspacing="0" width="100%">
					  <tr class="sdRowColor" valign="top">
						...
						<td width="50" align="center">
						  <select id="Result<?= $i ?>" name="Result<?= $i ?>" class="defectNature" onchange="$('Sms').value='1';">
							<option value=""></option>
							<option value="P">Pass</option>
							<option value="F">Fail</option>
						  </select>
						  ...
						  <script type="text/javascript">
						  <!--
							document.frmData.Result<?= $i ?>.value = "<?= $objDb->getField($i, 'result') ?>";
						  -->
						  </script>
						</td>
