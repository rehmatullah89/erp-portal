...
?>
				  ...
				  <tr>
					<td>Colors</td>
					<td align="center">:</td>
					<td><input type="text" name="Colors" value="<?= $Colors ?>" size="50" class="textbox" /></td>
				  </tr>
				</table>
...
?>
				...
				<br/><br/>
                                <h2>Color Wise Controlled Quantities</h2>
...
<?
		...
		{
?>
					  <td width="10%" align="center"><input type="text" name="CartonNos<?= $iIndex ?>[]" value="<?= $sCartonNos[$i] ?>" size="9" maxlength="10" class="textbox" /></td>
<?
		}
?>
				    </tr>
...
?>
                      ...
                      <tr>
					    ...
					    <td colspan="5"><input type="text" id="Remarks<?= $i ?>" name="Remarks<?= $i ?>" value="<?= $objDb->getField($i, 'remarks') ?>" maxlength="100" class="textbox defectRemarks" style="width:97.5%;" onchange="$('Sms').value='1';" /></td>
					  </tr>
				...
				<table border="1" bordercolor="#ffffff" cellpadding="0" cellspacing="0" width="100%">
				  <tr valign="top">
					...
					<td width="50%">
					  ...
					  <table border="0" cellpadding="3" cellspacing="0" width="100%">
					    <tr>
						  <td width="140">Cartons Quantity</td>
						  <td width="20" align="center">:</td>
...
<?
        ...
        $sTotalPos = $PO;
        if($iAdditionalPos != "")
            $sTotalPos = $sTotalPos.','.$AdditionalPos;
        
        $iOrderQty = 0;
        
        foreach ($sColors as $sColor)
        {                
                $iColorQty = getDbValue("order_qty", "tbl_po_colors", "po_id IN ($sTotalPos) AND color LIKE '$sColor' AND style_id='$Style'");
					  ...
					  <table border="0" cellpadding="0" cellspacing="0" width="116">
					    <tr>
						  ...
						  <td width="34"><img src="images/icons/calendar.gif" width="34" height="22" alt="Pick Date" title="Pick Date" style="cursor:pointer;"  onclick="displayCalendar($('ShipmentDate'), 'yyyy-mm-dd', this);" /></td>
                                    ...
                                    <td width="140">Offered Quantity</td>
                                    <td width="20" align="center">:</td>
                                    <td><input type="text" name="AuditQuantity" value="<?= $AuditQuantity ?>" size="10" class="textbox" /></td>
		              </tr>
