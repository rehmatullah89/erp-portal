	...
	if ($bFlag == true)
	{
		...
		$sSQL  = ("INSERT INTO tbl_arcadia_inspection_summary SET audit_id                      = '$Id',
		                                                      ...
		                                                      fabric_weight_remarks         = '".IO::strValue("FabricWeightRemarks")."',
                                                                      woven_weight                  = '".IO::strValue("WovenWeight")."',
		                                                      woven_weight_remarks          = '".IO::strValue("WovenWeightRemarks")."',
		                                                      ...
		                                                      carton_sticker                = '".IO::strValue("CartonSticker")."',
		                                                      carton_sticker_remarks        = '".IO::strValue("CartonStickerRemarks")."',
...
//		$iDefective += (int)getDbValue("COUNT(DISTINCT(sample_no))", "tbl_qa_report_defects", "audit_id='$Id' AND nature='0' AND sample_no NOT IN (SELECT DISTINCT(qrd.sample_no) FROM tbl_qa_report_defects qrd WHERE qrd.audit_id='$Id' AND qrd.nature>'0') HAVING SUM(defects)>='3'");
