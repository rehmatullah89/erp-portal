<?
	...
	***********************************************************************************************
	...
	$sSQL = "SELECT DATE_FORMAT(qa.audit_date, '%b %Y') AS _MonthYear,
			 ...
			 WHERE po.id=qa.po_id AND qa.audit_type='B' AND qa.audit_result!='' AND qa.audit_date>='$sDate' AND qa.vendor_id='$Vendor'
...
?>
				  <h2>Avergae Points Analysis (Monthly)</h2>
<?
		}
	}
...
?>
				  <h2>Defect Rate Analysis (Monthly)</h2>
<?
	}
...
?>
				  <div class="tblSheet">
						...
						<!--
						var objChart = new FusionCharts("scripts/fusion-charts/charts/MSLine.swf", "DefectRateYearlyGraph", "100%", "420", "0", "1");
