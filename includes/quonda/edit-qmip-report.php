...
?>
				  ...
				  <tr>
					<td>Colors</td>
					<td align="center">:</td>
					<td><input type="text" name="Colors" value="<?= $Colors ?>" size="30" width="250" class="textbox" /></td>
				  </tr>

				  <tr>
					<td>Bundle</td>
					<td align="center">:</td>
					<td><input type="text" name="Bundle" value="<?= $Bundle ?>" size="30" maxlength="100" class="textbox" /></td>
				  </tr>

                                  <tr>
					<td>Lot No.</td>
					<td align="center">:</td>
					<td><input type="text" name="LotNo" value="<?= $LotNo ?>" size="30" maxlength="100" class="textbox" /></td>
				  </tr>
				</table>
...
?>
						...
						<td width="100" align="center">
						  ...
						  -->
                                                ...
                                                <td width="100" align="center">
						  <select id="Status<?= $i ?>" name="Status<?= $i ?>" class="workStatus" onchange="$('Sms').value='1';">
		        		            <option value=""></option>  
                                                    <option value="R">Re-Work</option>
                                                    <option value="W">Wasted</option>
						  </select>

						  <script type="text/javascript">
						  <!--
							document.frmData.Status<?= $i ?>.value = "<?= $objDb->getField($i, 'status') ?>";
						  -->
						  </script>
						</td>
...
?>
				...
				<table border="0" cellpadding="3" cellspacing="0" width="100%">
			      ...
			      <tr>
				    <td>EMB Approval</td>
				    <td align="center">:</td>
				    <td><input type="text" name="EmbApproval" value="<?= $EmbApproval ?>" size="8" maxlength="10" class="textbox" /></td>
			      </tr>

			      <tr>
				    <td>GSM Weight</td>
				    <td align="center">:</td>
				    <td><input type="text" name="GsmWeight" value="<?= $GsmWeight ?>" size="8" maxlength="10" class="textbox" /></td>
			      </tr>
