...
<table border="0" cellpadding="3" cellspacing="0" width="100%">
    <tr>
        ...
        <td width="20" align="center">:</td>
        <td><input type="checkbox" name="CApprovedSample" value="Y" <?= (($CApprovedSample == "Y") ? "checked" : "") ?> /></td>
    </tr>
    <tr>
        <td width="230">Conform of Printing/Colour Swatche</td>
        <td width="20" align="center">:</td>
        <td><input type="checkbox" name="PrintingSwatche" value="Y" <?= (($PrintingSwatche == "Y") ? "checked" : "") ?> /></td>
    </tr>
    <tr>
        <td width="230">Conform of all Sewn-in/Product Labels</td>
        <td width="20" align="center">:</td>
        <td><input type="checkbox" name="ProductLabels" value="Y" <?= (($ProductLabels == "Y") ? "checked" : "") ?> /></td>
    </tr>
    <tr>
        <td width="230">Fit conform to Approved PP sample</td>
        <td width="20" align="center">:</td>
        <td><input type="checkbox" name="FitApprovedSample" value="Y" <?= (($FitApprovedSample == "Y") ? "checked" : "") ?> /></td>
    </tr>
    <tr>
        <td width="230">Measurement Sheet</td>
        <td width="20" align="center">:</td>
        <td><input type="file" name="MeasurementSheet" value="<?=$MeasurementSheet?>"/>
<?      if($MeasurementSheet != ""){?>
            <a href="<?= QUONDA_PICS_DIR."leverstyle/".@basename($MeasurementSheet) ?>" class="lightview" rel="gallery" title="<?= $MeasurementSheet ?> :: :: topclose: true">View Attachment</a>
<?      }?>
        </td>
    </tr>
    <tr valign="top">
        ...
        <td width="20" align="center">:</td>
        <td><textarea name="ProductRemarks" class="textarea" style="width:98%; height:80px;"><?= $ProductRemarks ?></textarea></td>
    </tr>
</table>
				<br />
				...
				<table border="0" cellpadding="3" cellspacing="0" width="100%">
			      ...
			      <tr>
				    <td>Washing</td>
				    <td align="center">:</td>
				    <td><input type="text" name="Washing" value="<?= $Washing ?>" size="8" maxlength="10" class="textbox" /></td>
			      </tr>

                              <tr>
				    <td>Pressing</td>
				    <td align="center">:</td>
				    <td><input type="text" name="Pressing" value="<?= $Pressing ?>" size="8" maxlength="10" class="textbox" /></td>
			      </tr>
