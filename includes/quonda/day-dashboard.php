...
<?
		...
		{
?>
				    <span style="float:right; padding-right:5px;">[ <a href="quonda/dashboard.php?Type=Recent" style="color:#ffff00;">Recent Audits</a> ]</span>
<?
		}
	}
?>
...
<?
	...
	if ($Brand == 0 && $Region == 0 && getDbValue("show_user_schedules", "tbl_users", "id='{$_SESSION['UserId']}'") == "Y" || $_SESSION["Admin"] == "Y")
	{
		$iLocations = array( );
	...
	if (($_SESSION['UserType'] == 'MATRIX' || $_SESSION['UserType'] == 'TRIPLETREE') && $Region == 0)
	{	
		$iAuditors = array( );
...
<?
		if (@strpos($sCity, "Activities") !== FALSE && ($_SESSION['UserType'] == 'MATRIX' || $_SESSION['UserType'] == 'TRIPLETREE') && $Region == 0)
		{		
//							'' AS _Line,
			$sSQL = "SELECT id,
