...
<?
		...
		@include("../".$sBaseDir."includes/quonda/hohenstein/save-description-and-quantity-of-product.php");
...
<?
        if($bFlag == true)
        {
            ...
            header("Location: edit-general-report-section.php?AuditId={$Id}&Section={$SectionId}");
        }
        else
        {
