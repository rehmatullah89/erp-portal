...
<div style="margin:1px 0px 0px 1px; _margin:0px; #margin:0px;">
    <form name="frmData" id="frmData" method="post" enctype="multipart/form-data" action="quonda/update-ppmeeting-section.php" class="frmOutline">
        ...
        <table border="1" bordercolor="#ffffff" cellpadding="5" cellspacing="0" width="100%" id="ShoulderPaddingTable">
...
?>
<div style="margin:1px 0px 0px 1px; _margin:0px; #margin:0px;">
        <h3>List of Existing Shoulder Padding Data</h3>
...
<?
             $sSQL = "SELECT * FROM tbl_ppmeeting_shoulder_padding WHERE audit_id='$Id'";
             $objDb->query($sSQL);
...
<script type="text/javascript">
    ...
    var i=2;
    function AddRow() {
        var table = document.getElementById("ShoulderPaddingTable");
