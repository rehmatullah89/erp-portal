	...
	***********************************************************************************************
	...
	if ($bFlag == true)
	{
		$sSQL  = ("INSERT INTO tbl_ar_beautiful_products (audit_id, c1, c2, c3, c4, c5, c6, c7, c8, c9) VALUES
														 ('$Id', '".IO::intValue("C1")."', '".IO::intValue("C2")."', '".IO::intValue("C3")."', '".IO::intValue("C4")."', '".IO::intValue("C5")."', '".IO::intValue("C6")."', '".IO::intValue("C7")."', '".IO::intValue("C8")."', '".IO::intValue("C9")."')");
		$bFlag = $objDb->execute($sSQL);
	}
