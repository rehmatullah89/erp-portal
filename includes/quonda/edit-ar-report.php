...
?>
			    ...
			    <table border="0" cellpadding="3" cellspacing="0" width="100%">
				  <tr>
				    ...
				    <td width="25"><input type="checkbox" name="CounterSampleAppr" value="Y" <?= (($CounterSampleAppr == "Y") ? "checked" : "") ?> /></td>
				  ...
				  <tr valign="top">
					<td width="33%">
					  ...
					  <table border="0" cellpadding="3" cellspacing="0" width="100%">
					    ...
					    <tr>
						  <td><input type="checkbox" name="Printing" value="Y" <?= (($Printing == "Y") ? "checked" : "") ?> /></td>
						  <td>Printing</td>
					    </tr>

					    <tr>
						  <td><input type="checkbox" name="Embridery" value="Y" <?= (($Embridery == "Y") ? "checked" : "") ?> /></td>
						  <td>Embridery</td>
					    </tr>
					  </table>
					...
					<td width="34%">
					  ...
					  <table border="0" cellpadding="3" cellspacing="0" width="100%">
					    ...
					    <tr>
						  <td><input type="checkbox" name="AdiComp" value="Y" <?= (($AdiComp == "Y") ? "checked" : "") ?> /></td>
						  <td>Adi Comp</td>
					    </tr>
					  </table>
					</td>
					...
					<td width="33%">
					  ...
					  <table border="0" cellpadding="3" cellspacing="0" width="100%">
					    <tr>
						  <td width="25"><input type="checkbox" name="ShippingMark" value="Y" <?= (($ShippingMark == "Y") ? "checked" : "") ?> /></td>
						  <td>Shipping Mark</td>
					    </tr>

					    <tr>
						  <td><input type="checkbox" name="ColourSizeQty" value="Y" <?= (($ColourSizeQty == "Y") ? "checked" : "") ?> /></td>
					    ...
					    <tr>
						  <td><input type="checkbox" name="OclUpc" value="Y" <?= (($OclUpc == "Y") ? "checked" : "") ?> /></td>
						  <td>OCL/UPC</td>
					    </tr>
					  </table>
					</td>
