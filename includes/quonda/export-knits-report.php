<?
	...
	***********************************************************************************************
	...
	$iPageCount  = $objPdf->setSourceFile($sBaseDir."templates/knits-report.pdf");
	...
	$objPdf->Text(83, 23.2, strtoupper($sReportTypeName));
	...
	$objPdf->Text(24, 54.5, $sDestination);
	...
	$objPdf->Text(195, 234, @round((($iMajorDefects / $iTotalGmts) * 100), 2));
	...
	$objPdf->Text(21, 37.5, $sBrand);
	$objPdf->Text(78, 37.5, $sVendor);
	$objPdf->Text(139, 37.5, formatDate($sAuditDate));
	$objPdf->Text(184, 37.5, $sAuditor);

	$objPdf->Text(13, 48.2, ($sPo.$sAdditionalPos));
	$objPdf->Text(83, 48.2, $sStyle);
	$objPdf->Text(140, 48.2, formatNumber($iQuantity, false));
	$objPdf->Text(185, 48.2, formatNumber($iShipQty, false));

	$objPdf->Text(24, 58.5, $sDestination);
	
        $objPdf->SetXY(78, 56.5);
	$objPdf->MultiCell(22, 3.2, $sSizeTitles, 0);
        
	$objPdf->SetXY(116, 56.5);
	$objPdf->MultiCell(57, 3.2, $sColors, 0);
        
        $objPdf->Text(195, 58.5, formatNumber($fCartonsShipped, false));

	$objPdf->Text(26, 70, $sDescription);
	$objPdf->Text(140, 71, $sAuditStatus);
	$objPdf->Text(175, 71, strtoupper($sAuditStage));
	...
	$objPdf->SetFont('Arial', '', 11);
        $objPdf->SetTextColor(0, 0, 0);
	$objPdf->Text(116.2, 46.2, formatNumber($fAql, true, (($fAql < 1) ? 2 : 1)));
