...
<?
            ...
            $sComments      = getDbValue("signatures_comments", "tbl_qa_reports", "id='$Id'");
	...
	<h3>Signature info</h3>
        <table border="1" bordercolor="#ffffff" cellpadding="5" cellspacing="0" width="100%" id="MasterCartonsTable">
            <tr>
                ...
                <td>
                    <input type="text" name="Inspector" value="<?=$sInspector?>" size="20" required=""/>
                    <a href="includes/quonda/signature.php?AuditId=<?=$Id?>&Section=8&UserType=Inspector&AuditDate=<?=$sAuditDate?>" rel="iframe" title=""><img src="images/icons/sig.png" alt="Create Inspector Signature" title="Create Inspector Signature" width="20" hspace="1" height="20"></a>
                </td>
                <td width="250">
                    <input type="file" name="InspectorSign" value=""/>(JPG Only!)
...
?>
                ...
                <td>
                    <input type="text" name="Manufacturer" value="<?=$sManufacturer?>" size="20" required=""/>
                    <a href="includes/quonda/signature.php?AuditId=<?=$Id?>&Section=8&UserType=Manufacturer&AuditDate=<?=$sAuditDate?>" rel="iframe" title=""><img src="images/icons/sig.png" alt="Create Manufacturer Signature" title="Create Manufacturer Signature" width="20" hspace="1" height="20"></a>
                </td>
                <td width="250">
                    <input type="file" name="ManufactureSign" value=""/>(JPG Only!)                    
<?
