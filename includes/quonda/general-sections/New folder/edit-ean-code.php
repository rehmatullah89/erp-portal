...
// var_dump($Styles);exit;
    ...
    // $Styles          = getDbValue("styles", "tbl_qa_reports", "id='$Id'");            
    ...
    // var_dump($Id,$Styles,$iCount);exit;
...
<?
    for($i = 0; $i < $iCount; $i ++)
    {
        ...
        $result = '-';
        $iFailedResults = getDbValue('COUNT(result)', 'tbl_qa_ean_codes', "audit_id='$Id' AND size_id='$iSize' AND style_id='$iStyle' AND result='F'");

        if($iFailedResults > 0){
            $result = "F";
        } else {

            $iPassResults = getDbValue('COUNT(result)', 'tbl_qa_ean_codes', "audit_id='$Id' AND size_id='$iSize' AND style_id='$iStyle' AND result='P'");
...
?>
    <table border="1" bordercolor="#ffffff" cellpadding="5" cellspacing="0" width="100%" >
        <tr class="sdRowColor">
          ...
          <td width="20" align="center"><span id="result<?= $iId ?>"><?=$result?></span></td>
    ...
    <div style="padding:1px;">
          ...
          <form name="frmData<?= $iId ?>" id="frmData<?= $iId ?>" onsubmit="return false;" class="frmInlineEdit">
            ...
            <div style="padding-top: 10px;">
                    ...
                    <tr id="row<?=$rowCount?>">
                        <td>Position : <input type="text" class="textbox" name="Position[]" value="<?=$position?>"></td>
                        <td>EAN : <input type="text" <?=$fieldStyle?> class="textbox eanField" name="EanCodes[]" value="<?=$code?>" id="ean-<?= $iId ?>-<?=$rowCount?>"></td>
...
?>
    ...
    <form name="frmData" id="frmData" method="post" enctype="multipart/form-data" action="includes/quonda/update-hohenstein-section.php">
            ...
            <table border="1" bordercolor="#ffffff" cellpadding="5" cellspacing="0" width="100%">
                ...
                <tr>
                    <td colspan="3"><div style="float: right; padding: 10px;">
  ...
  <link type="text/css" rel="stylesheet" href="css/jquery.tokeninput.css" />
    ...
    function addEanRow(id) {
        ...
        $html += '<tr>';
        $html += '<td>Position : <input type="text" name="Position[]" class="textbox" /></td>'
        $html += '<td>EAN : <input type="text" id="ean-'+id+'-'+i+'" name="EanCodes[]" class="textbox eanField" /></td>'
