<?
	...
	***********************************************************************************************
	...
	switch ($AuditStage)
	{
		case "C"  : $fTargetDhu = $objDb->getField(0, 'cutting_dr');     break;
		case "O"  : $fTargetDhu = $objDb->getField(0, 'output_dr');     break;
		case "B"  : $fTargetDhu = $objDb->getField(0, 'batch_dr');     break;
		case "F"  : $fTargetDhu = $objDb->getField(0, 'final_dr');   break;
		case "S"  : $fTargetDhu = $objDb->getField(0, 'sorting_dr');   break;
		case "ST" : $fTargetDhu = $objDb->getField(0, 'stitching_dr');  break;
		case "FI" : $fTargetDhu = $objDb->getField(0, 'finishing_dr');  break;
		case "OL" : $fTargetDhu = $objDb->getField(0, 'off_loom_dr');  break;
		case "SK" : $fTargetDhu = $objDb->getField(0, 'stock_dr');     break;
		case "P"  : $fTargetDhu = $objDb->getField(0, 'pre_final_dr');   break;
		case "I"  : $fTargetDhu = $objDb->getField(0, 'in_process_dr'); break;
	}
