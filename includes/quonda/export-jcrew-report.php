...
//	$sMiscImages    = getList("tbl_qa_report_images", "id", "UPPER(image)", "audit_id='$Id' AND `type`='M' AND image LIKE '%.jpg'");//misc
	$sLabImages     = getList("tbl_qa_report_images", "id", "image", "audit_id='$Id' AND `type`='L' AND image LIKE '%.jpg'");//lab
        $sMiscImages    = getList("tbl_qa_report_images", "id", "image", "audit_id='$Id' AND (`type`='M' OR `type`='PFV' OR `type`='PBV' OR `type`='CW') AND image LIKE '%.jpg'"); //other misc
	...
	$objPdf->SetFont('helvetica', '', 6);
        ...
        $objPdf->SetXY(130, 63);
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sShippingMarksRemarks, 0, "L");
	...
	if ($sMaterialConformity != "")
        ...
        $objPdf->SetXY(130, 68);
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sMaterialConformityRemarks, 0, "L");
	...
	if ($sProductColour != "")
        ...
        $objPdf->SetXY(130, 83);
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, str_replace("’","'",$sCartonStickerRemarks), 0, "L");
	...
	if ($sExportCartonPacking != "")
        ...
        $objPdf->SetXY(130, 88);
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sExportCartonPackingRemarks, 0, "L");
	...
	if ($sInnerCartonPacking != "")
        ...
        $objPdf->SetXY(130, 93);
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sInnerCartonPackingRemarks, 0, "L");
	...
	if ($sProductPackaging != "")
        ...
        $objPdf->SetXY(130, 98);
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sProductPackagingRemarks, 0, "L");
	...
	if ($sMarkings != "")
        ...
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sMarkingsRemarks, 0, "L");
	...
	if ($sWorkmanship != "")
        ...
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sWorkmanshipRemarks, 0, "L");
	...
	if ($sAppearance != "")
        ...
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sAppearanceRemarks, 0, "L");
	...
	if ($sFunction != "")
        ...
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sFunctionRemarks, 0, "L");
	...
	if ($sPrintedMaterials != "")
        ...
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sPrintedMaterialsRemarks, 0, "L");
	...
	if ($sWorkmanshipFinishing != "")
        ...
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sWorkmanshipFinishingRemarks, 0, "L");
        ...
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sFittingRemarks, 0, "L");
	...
	if ($sMeasurement != "")
        ...
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sMeasurementRemarks, 0, "L");
	...
	if ($sFabricWeight != "")
        ...
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sFabricWeightRemarks, 0, "L");
	...
	if ($sWovenWeight != "")
        ...
        $objPdf->setCellHeightRatio(1.0);
        $objPdf->MultiCell(70, 2.5, $sWovenWeightRemarks, 0, "L");
