<?
	...
	***********************************************************************************************
	...
	$iPageCount  = $objPdf->setSourceFile($sBaseDir."templates/arcadia.pdf");
	...
	$objPdf->SetFont('Arial', '', 9);
	$objPdf->Text(125, 24, $sBrand);
	$objPdf->Text(125, 29, $sAuditStage);
	$objPdf->Text(125, 34, formatDate($sAuditDate));
	...
	$objPdf->Text(135, 24, $sBrand);
	$objPdf->Text(135, 29, $sAuditStage);
	$objPdf->Text(135, 34, formatDate($sAuditDate));
...
//			$objPdf->Text(38, 52.2, $sQtyPerSize);
	...
	if (count($sDefects) > 0)
	{
		$iPageCount  = $objPdf->setSourceFile($sBaseDir."templates/arcadia-page.pdf");
		$iTemplateId = $objPdf->importPage(1, '/MediaBox');
