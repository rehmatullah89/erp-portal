<?
	...
	***********************************************************************************************
	...
	if ($bFlag == true)
	{
		...
		$sSQL  = ("INSERT INTO tbl_kik_inspection_summary SET audit_id                      = '$Id',
	...
	if ($bFlag == true)
	{
		for ($i = 1; $i <= 10; $i ++)
		{
			...
			if (getDbValue("COUNT(1)", "tbl_kik_samples_per_size", ("audit_id='$Id' AND size_color='".IO::strValue("SizeColor{$i}")."'")) > 0)
			{
			...
			$sSQL  = ("INSERT INTO tbl_kik_samples_per_size SET audit_id   = '$Id',
																size_color = '".IO::strValue("SizeColor{$i}")."',
