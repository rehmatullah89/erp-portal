...
?>
			...
			<table border="0" cellpadding="3" cellspacing="0" width="100%">
			  <tr>
				...
				<td width="25"><input type="checkbox" name="SealingSampleAppr" value="Y" <?= (($sSealingSampleAppr == "Y") ? "checked" : "") ?> disabled /></td>
			  ...
			  <tr>
				<td><input type="checkbox" name="MetalDetection" value="Y" <?= (($sMetalDetection == "Y") ? "checked" : "") ?> disabled /></td>
			  ...
			  <tr valign="top">
				...
				<td width="34%">
				  ...
				  <table border="0" cellpadding="3" cellspacing="0" width="100%">
					...
					<tr>
					  <td><input type="checkbox" name="DecorativeLabel" value="Y" <?= (($sDecorativeLabel == "Y") ? "checked" : "") ?> disabled /></td>
					  <td>Decorative Label</td>
					</tr>

					<tr>
					  <td><input type="checkbox" name="CareLabel" value="Y" <?= (($sCareLabel == "Y") ? "checked" : "") ?> disabled /></td>
					  <td>Care Label</td>
					</tr>

					<tr>
					  <td><input type="checkbox" name="SecurityLabel" value="Y" <?= (($sSecurityLabel == "Y") ? "checked" : "") ?> disabled /></td>
					  <td>Security Label</td>
					</tr>

					<tr>
					  <td><input type="checkbox" name="AdditionalLabel" value="Y" <?= (($sAdditionalLabel == "Y") ? "checked" : "") ?> disabled /></td>
				...
				<td width="33%">
				  ...
				  <table border="0" cellpadding="3" cellspacing="0" width="100%">
					<tr>
					  <td width="25"><input type="checkbox" name="OclUpc" value="Y" <?= (($sOclUpc == "Y") ? "checked" : "") ?> disabled /></td>
					  <td>Outer Carton Labels</td>
					</tr>

					<tr>
					  <td><input type="checkbox" name="PackingMode" value="Y" <?= (($sPackingMode == "Y") ? "checked" : "") ?> disabled /></td>
					  <td>Packing Mode</td>
					</tr>
...
<?
	...
	{
?>
				  <td align="center"><?= $objDb->getField(0, "c{$i}") ?></td>
<?
	}
?>
				</tr>
