<?
	...
	***********************************************************************************************
	...
	$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, 'GT Number');
	...
	$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, 'Customer Number');
	$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, 'Article Number');
	...
	if ($sCategories['knitting'] > 0)
	{
		...
		$objPHPExcel->getActiveSheet()->mergeCells(getExcelCol($iColumn).$iRow.':'.getExcelCol($iColumn + 1).$iRow);

		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).($iRow + 1), 'Planned');
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).($iRow + 1), 'Actual');
	...
	if ($sCategories['cutting'] > 0)
	{
		...
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn).$iRow, 'Cutting Pieces');
		$objPHPExcel->getActiveSheet()->mergeCells(getExcelCol($iColumn).$iRow.':'.getExcelCol($iColumn + 1).$iRow);
	...
	$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, 'Sewing Line Number / Identification');
	$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, 'Per Line Productivity');
	...
	if ($sCategories['print_embroidery'] > 0)
	{
		...
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn).$iRow, 'Print/Embroidery Pieces');
		$objPHPExcel->getActiveSheet()->mergeCells(getExcelCol($iColumn).$iRow.':'.getExcelCol($iColumn + 1).$iRow);
	...
	if ($sCategories['stitching'] > 0)
	{
		...
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn).$iRow, 'Stitching Pieces');
		$objPHPExcel->getActiveSheet()->mergeCells(getExcelCol($iColumn).$iRow.':'.getExcelCol($iColumn + 1).$iRow);
	...
	if ($sCategories['packing'] > 0)
	{
		...
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn).$iRow, 'Packing Pieces');
		$objPHPExcel->getActiveSheet()->mergeCells(getExcelCol($iColumn).$iRow.':'.getExcelCol($iColumn + 1).$iRow);
	...
	$objPHPExcel->getActiveSheet()->duplicateStyleArray(
			...
			(getExcelCol(65).($iRow + 1).':'.getExcelCol($iColumn).($iRow + 1))
	);
	...
	for ($i = 0; $i < $iCount; $i ++, $iRow ++)
	{
		...
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, $objDb2->getField(0, 'gt_no'));
		...
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatNumber($iQuantity, false));
		...
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, $objDb2->getField(0, 'customer_no'));
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, $objDb2->getField(0, 'article_no'));
		...
		if ($sCategories['cutting'] > 0)
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatNumber($iQuantity, false));
			$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatDate($objDb2->getField(0, 'cutting_pieces')));
		...
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, $objDb2->getField(0, 'sewing_line'));
		$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, $objDb2->getField(0, 'per_line_productivity'));
		...
		if ($sCategories['print_embroidery'] > 0)
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatNumber($iQuantity, false));
			$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatDate($objDb2->getField(0, 'print_embroidery_pieces')));
		...
		if ($sCategories['stitching'] > 0)
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatNumber($iQuantity, false));
			$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatDate($objDb2->getField(0, 'stitching_pieces')));
