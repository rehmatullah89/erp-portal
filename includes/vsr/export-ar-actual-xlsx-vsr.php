	...
	***********************************************************************************************
	...
	for ($i = 0; $i < $iCount; $i ++, $iRow ++)
	{
		...
		if ($sCategories['cutting'] > 0)
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatNumber($objDb2->getField(0, 'cutting_pieces'), false));
		...
		if ($sCategories['print_embroidery'] > 0)
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatNumber($objDb2->getField(0, 'print_embroidery_pieces'), false));
		...
		if ($sCategories['stitching'] > 0)
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatNumber($objDb2->getField(0, 'stitching_pieces'), false));
		...
		if ($sCategories['packing'] > 0)
		{
			...
			$objPHPExcel->getActiveSheet()->setCellValue(getExcelCol($iColumn ++).$iRow, formatNumber($objDb2->getField(0, 'packing_pieces'), false));
