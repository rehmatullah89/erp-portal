<?
	...
	***********************************************************************************************
	...
	$sSQL = "SELECT style, style_name, brand_id, (SELECT brand FROM tbl_brands WHERE id=tbl_styles.sub_brand_id) AS _Brand FROM tbl_styles WHERE id='$iStyle'";
	$objDb->query($sSQL);
...
//	$objPdf->Text(176, 232.0, $iGmtsDefective);
	...
	$sCodes = array("0", "0", "101", "102", "103", "104", "105", "0", "107", "108", "109", "110", "111", "112", "0",
					"0", "0", "201", "0", "203", "204", "205", "0", "207", "208", "0",
					"0", "0", "0", "302", "303", "0", "305", "306", "0",
					"0", "0", "401", "402", "403", "404", "405", "406", "407", "408", "409", "0",
					"0", "0", "501", "502", "503", "0", "0", "0", "0", "508", "0",
	...
	$sPdfFile = ($sBaseDir.TEMP_DIR."M{$Id}-Inflatable-QA-Report.pdf");
