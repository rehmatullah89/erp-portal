	...
	***********************************************************************************************
	...
	if ($objDb->getCount( ) == 1)
	{
		...
		$sModifiedBy            = $objDb->getField(0, "_ModifiedBy");
                $sAppVersion           = $objDb->getField(0, "app_version");
...
<?
	if ($iReportId == 6)
	...
	else if ($iReportId == 14 || $iReportId == 34 || $ReportId == 47)
        ...
        else if (@in_array($iReportId, array(46)) && $sAppVersion > 275)
		@include($sBaseDir."includes/quonda/view-jcrew-report-new.php"); 
        
        else if (@in_array($iReportId, array(46)))
