...
?>
                         <tr>
						  ...
						  <td>
                                                      <select name="Report" id="ReportId" onchange="getListValues('ReportId', 'Brand', 'ReportBrands');">
							  <option value=""></option>
<?
...
?>
                        <tr>
                            <td width="95">Inspection Level<span class="mandatory">*</span></td>
                            <td width="20" align="center">:</td>
                            <td>
...
?>			  
                        <tr>
                            <td width="80">AQL Level<span class="mandatory">*</span></td>
                            <td width="20" align="center">:</td>
                            <td>
