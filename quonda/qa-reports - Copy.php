...
*/
	...
	$sSQL = "SELECT id, user_id, audit_code, po_id, vendor_id, audit_stage, audit_result, audit_date, report_id, published, audit_type_id, total_gmts,
...
<?
		...
		if ($iPoId > 0)
		{
			...
			$iBrandId = $objDb2->getField(0, 'brand_id');
                ...
                {
                    if($iAuditTypeId == 2 && $iTotalGmts == 32)
                        $sAuditStage = "V";
                }
