...
?>
				      ...
				      <td width="19%">
<?
		if ($sUserRights['Edit'] == "Y" && ($_SESSION["UserId"] == 1 || ($iReportId != 14 && $iReportId != 34) || /*($sAuditResult == 'Hold' && ($iUserId == $_SESSION['UserId'] || $sAuditsManager == "Y")) ||*/ (($iReportId == 14 || $iReportId == 34) && $sPublished != "Y" && ($iUserId == $_SESSION['UserId'] || $sAuditsManager == "Y"))) && ($_SESSION["UserType"] != "JCREW" || ($_SESSION["UserType"] == "JCREW" && $iReportId == 46)))
		{
?>
...
<?
		...
		if ($sUserRights['Delete'] == "Y" && ($_SESSION["UserType"] != "JCREW" || ($_SESSION["UserType"] == "JCREW" && $iReportId == 46)))
		{
?>
...
/*        if ($iCount > 0 && $_SESSION["UserType"] == "MGF" && ($AuditCode != "" || $Customer != "" || $OrderNo != "" || $Program != 0 || $Season != 0||  $DesignNo != "" || $AuditorType != 0|| $DesignName != "" || $ReportStatus != "" || $Floor != "" || $AuditStage != "" || $MasterId != "" || $Unit != "" || $Line != 0  || $AuditResult != "" || $Department != 0 || $Brand != 0 || $StyleNo != "" || $Report != 0 || $Color != "" || $Auditor != 0 || $Vendor != 0 || ($FromDate != "" && $ToDate != "") || $Region != 0 ))
	{
?>
