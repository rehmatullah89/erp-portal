...
//			$sUserStyleList  = getList("tbl_po", "styles", "vendor_id IN ($sUserVendors)");
			...
			$sStyleList  = getList("tbl_styles", "id","style", "id IN ($sUserStyleList)"); //return valued
...
*/
			...
			$sDRList[3] = "DR Rate 3.0 +"; 
			$sDRList[2] = "DR Rate 2.0 +"; 
			$sDRList[1] = "DR Rate 1.0 +"; 
			...
			foreach ($sVendorsList as $sKey => $sValue){
				...
				//print_r($sStyleList); exit(0);
				
			foreach ($sStyleList as $sKey => $sValue){
//				$sStyle[$key]["id"] = $sKey;
				$sStyle[$key] = $sValue;
				}
