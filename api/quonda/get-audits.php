	...
	***********************************************************************************************
	...
	else
	{
		...
		else
		{
			...
			if ($Status == "")
				$sConditions .= " user_id='$User' AND approved='Y' AND (audit_result='' OR ISNULL(audit_result)) AND FIND_IN_SET(report_id, '6') ";

			else
				$sConditions .= " audit_result!='' AND FIND_IN_SET(report_id, '6') ";
