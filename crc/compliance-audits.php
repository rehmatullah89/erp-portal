<?
	...
	***********************************************************************************************
	...
	if ($PostId != "")
	{
		...
		$AuditType      = IO::intValue("AuditType");
		$SalariedStaff  = IO::intValue("SalariedStaff");
		$ContractStaff  = IO::intValue("ContractStaff");
		$MaleStaff      = IO::floatValue("MaleStaff");
		$FemaleStaff    = IO::floatValue("FemaleStaff");
	}
	...
	$sTypesList    = getList("tbl_compliance_types", "id", "title");
...
?>
  <script type="text/javascript" src="scripts/crc/compliance-audits.js"></script>
</head>
...
<?
	...
	{
?>
				<form name="frmData" id="frmData" method="post" action="crc/save-compliance-audit.php" class="frmOutline" onsubmit="$('BtnSave').disabled=true;">
				<h2>Add Compliance Audit</h2>
...
?>
 				  ...
 				  <tr>
					<td>Audit Type<span class="mandatory">*</span></td>
					<td align="center">:</td>
...
<?
	...
	if ($AuditType > 0)
		$sSQL .= " AND type_id='$AuditType' ";

	if ($FromDate != "" && $ToDate != "")
		$sSQL .= " AND (audit_date BETWEEN '$FromDate' AND '$ToDate') ";


	@list($iTotalRecords, $iPageCount, $iStart) = getPagingInfo("tbl_compliance_audits", $sConditions, $iPageSize, $PageId);


	$sSQL = "SELECT id, vendor_id, audit_date, auditors FROM tbl_compliance_audits $sConditions ORDER BY id DESC LIMIT $iStart, $iPageSize";
	$objDb->query($sSQL);
...
<?
		...
		{
?>
				        <a href="crc/edit-compliance-audit.php?Id=<?= $iId ?>"><img src="images/icons/edit.gif" width="16" height="16" alt="Edit" title="Edit" /></a>
				        &nbsp;
<?
		}
		...
		{
?>
				        <a href="crc/delete-compliance-audit.php?Id=<?= $iId ?>" onclick="return confirm('Are you SURE, You want to Delete this Audit?');"><img src="images/icons/delete.gif" width="16" height="16" alt="Delete" title="Delete" /></a>
				        &nbsp;
<?
		}
?>
				        <a href="crc/view-compliance-audit.php?Id=<?= $iId ?>" class="lightview" rel="iframe" title="Compliance Audit :: :: width: 900, height: 650"><img src="images/icons/view.gif" width="16" height="16" alt="View" title="View" /></a>
				      </td>
				    </tr>
<?
	}
...
<?
	showPaging($PageId, $iPageCount, $iCount, $iStart, $iTotalRecords, "&AuditType={$AuditType}&Vendor={$Vendor}&Auditor={$Auditor}&FromDate={$FromDate}&ToDate={$ToDate}");
?>
