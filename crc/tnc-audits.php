...
?>
  ...
  <script type="text/javascript" src="scripts/crc/tnc-audits.js"></script>
...
<?
	...
	{
?>
				<form name="frmData" id="frmData" method="post" action="crc/save-tnc-audit.php" class="frmOutline" onsubmit="$('BtnSave').disabled=true;">
				<h2>Add New Audit</h2>
					  ...
					  <table border="0" cellpadding="0" cellspacing="0" width="116">
						<tr>
						  ...
						  <td width="34"><img src="images/icons/calendar.gif" width="34" height="22" alt="Pick Date" title="Pick Date" style="cursor:pointer;"  onclick="displayCalendar($('AuditDate'), 'yyyy-mm-dd', this);" /></td>
                                  ...
                                  <tr>
					<td width="60">Follow Up Audit?</td>
					<td width="20" align="center">:</td>
					<td>
                                            <input type="checkbox" name="FollowUpAudit" id="FollowUpAudit" value="<?= $FollowUpAudit ?>" <?= ($FollowUpAudit == '1'?'checked':'') ?>>						  
					</td>
				  </tr>
                                  <tr class="ParentAuditToggle">
                                      <td width="60">Parent Audit?</td>
					<td width="20" align="center">:</td>
                                        <td>
                                         <select name="PreviousAudit" id="PreviousAudit">
						<option value=""></option>    
                                         </select>
                                        </td>
                                    </tr>  
...
<?
	...
	@list($iTotalRecords, $iPageCount, $iStart) = getPagingInfo("tbl_tnc_audits", $sConditions, $iPageSize, $PageId);


	$sSQL = "SELECT id, vendor_id, audit_date, auditors, total_score, score FROM tbl_tnc_audits $sConditions ORDER BY id DESC LIMIT $iStart, $iPageSize";
	$objDb->query($sSQL);
...
<?
		...
		{
?>
				        <a href="crc/edit-tnc-audit.php?Id=<?= $iId ?>"><img src="images/icons/edit.gif" width="16" height="16" alt="Edit" title="Edit" /></a>
				        &nbsp;
                                        <a href="crc/tnc-audit-caps.php?Id=<?= $iId ?>"><img src="images/icons/deviation.gif" width="16" height="16" alt="Corrective Action Plan" title="Corrective Action Plan" /></a>
                                        &nbsp;
<?
		}
		...
		{
?>
				        <a href="crc/delete-tnc-audit.php?Id=<?= $iId ?>" onclick="return confirm('Are you SURE, You want to Delete this Audit?');"><img src="images/icons/delete.gif" width="16" height="16" alt="Delete" title="Delete" /></a>
				        &nbsp;
<?
		}
?>
				        <a href="crc/view-tnc-audit.php?Id=<?= $iId ?>" class="lightview" rel="iframe" title="T&C Audit :: :: width: 900, height: 650"><img src="images/icons/view.gif" width="16" height="16" alt="View" title="View" /></a>
						&nbsp;
						<a href="crc/tnc-audit-images.php?AuditId=<?= $iId ?>"><img src="images/icons/pictures.gif" width="16" height="16" hspace="1" alt="Pictures" title="Pictures" /></a>
				      </td>
				    </tr>
<?
	}
