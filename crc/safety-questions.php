...
?>
  <script type="text/javascript" src="scripts/crc/safety-questions.js"></script>
</head>
...
<?
	...
	{
?>
			    <form name="frmData" id="frmData" method="post" action="crc/save-safety-question.php" class="frmOutline" onsubmit="$('BtnSave').disabled=true;">
...
<?
	...
	@list($iTotalRecords, $iPageCount, $iStart) = getPagingInfo("tbl_safety_questions", $sConditions, $iPageSize, $PageId);


	$sSQL = "SELECT * FROM tbl_safety_questions $sConditions ORDER BY id DESC LIMIT $iStart, $iPageSize";
	$objDb->query($sSQL);
...
<?
		...
		{
?>
				        <a href="crc/delete-safety-question.php?Id=<?= $iId ?>" onclick="return confirm('Are you SURE, You want to Delete this Audit Question?');"><img src="images/icons/delete.gif" width="16" height="16" alt="Delete" title="Delete" /></a>
<?
		}
?>
				      </td>
