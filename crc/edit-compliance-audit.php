<?
	...
	***********************************************************************************************
	...
	if ($objDb->getCount( ) == 1)
	{
		...
		$AuditType      = $objDb->getField(0, "type_id");
...
?>
  <script type="text/javascript" src="scripts/crc/edit-compliance-audit.js"></script>
</head>
...
<!--  Body Section Starts Here  -->
	    <div id="Body">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr valign="top">
			  <td width="100%">
			   <h1><img src="images/h1/crc/compliance-audits.jpg" width="269" height="20" vspace="10" alt="" title="" /></h1>

			    <form name="frmData" id="frmData" method="post" action="crc/update-compliance-audit.php" enctype="multipart/form-data" class="frmOutline" onsubmit="$('BtnSave').disabled=true;">
...
<?
	...
	{
?>
				<h2><?= $Step ?>. <?= getDbValue("title", "tbl_compliance_categories", "id='$Step'") ?></h2>
<?
...
<?
				...
				{
?>
                          <div style="float:left; margin:10px 10px 0px 0px; text-align:center;"><a href="<?= (COMPLIANCE_AUDITD_DIR.$sPicture) ?>" class="lightview"><img src="<?= (COMPLIANCE_AUDITD_DIR.$sPicture) ?>" width="100" height="80" alt="" title="" /></a><br />[ <a href="crc/delete-compliance-picture.php?Id=<?= $Id ?>&Question=<?= $iQuestion ?>&Field=<?= $sField ?>">Delete</a> ]</div>
<?
				}
?>
				        </div>
...
?>
				...
				<div class="buttonsBar">
				  ...
				  <input type="button" value="" class="btnBack" title="Back" onclick="document.location='crc/<?= (($Step == 0) ? 'compliance-audits.php' : ('edit-compliance-audit.php?Id='.$Id.'&Step='.($Step - 1))) ?>';" />
				</div>
			    </form>
