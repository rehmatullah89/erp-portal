...
<!--  Body Section Starts Here  -->
	    <div id="Body">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr valign="top">
			  <td width="100%">
			    <h1><img src="images/h1/crc/dashboard.jpg" width="461" height="20" vspace="10" alt="" title="" /></h1>
...
?>
				                <div>
				                  <ul style="list-style:none; padding:0px; margin:10px 0px 0px 0px; height:140px; overflow:hidden;">
<?
						for ($i = 0; $i < $iCount; $i ++)
						{
							$sTitle     = $objDb->getField($i, "title");
							...
							if ($i > 0 && $sTitle != $objDb->getField(($i - 1), "title"))
								$iGroup ++;
?>
							        <li style="float:left; margin:0px 0px 0px 8px; height:135px; text-align:center;">
								      <div style="border:solid 1px #aaaaaa; padding:1px;">
								        <a href="<?= (CRC_AUDITS_IMG_PATH.$sPicture) ?>" class="lightview" rel="gallery<?= $iGroup ?>" title="<?= $sTitle ?> - <?= formatDate($sAuditDate, "F Y") ?> :: :: autosize:true :: :: topclose: true"><img src="<?= (CRC_AUDITS_IMG_PATH.$sPicture) ?>" width="160" height="120" alt="<?= $sTitle ?>" title="<?= $sTitle ?>" /></a>
								      </div>

								      <?= formatDate($sAuditDate, "F Y") ?>
							        </li>
<?
						}
?>
...
?>
							  ...
							  <div style="margin:15px 0px 0px 0px; border-top:solid 3px #cccccc;">
							    <table border="0" cellspacing="0" cellpadding="0" width="100%">
							      <tr bgcolor="#eeeeee">
