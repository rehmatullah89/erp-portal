...
?>
  <script type="text/javascript" src="scripts/crc/safety-audits.js"></script>
</head>
...
<?
	...
	{
?>
				<form name="frmData" id="frmData" method="post" action="crc/save-safety-audit.php" class="frmOutline" onsubmit="$('BtnSave').disabled=true;">
				<h2>Add Safety Audit</h2>
...
<?
	...
	@list($iTotalRecords, $iPageCount, $iStart) = getPagingInfo("tbl_safety_audits", $sConditions, $iPageSize, $PageId);


	$sSQL = "SELECT id, vendor_id, audit_date, auditors, rating FROM tbl_safety_audits $sConditions ORDER BY id DESC LIMIT $iStart, $iPageSize";
	$objDb->query($sSQL);
...
<?
		...
		{
?>
				        <a href="crc/edit-safety-audit.php?Id=<?= $iId ?>"><img src="images/icons/edit.gif" width="16" height="16" alt="Edit" title="Edit" /></a>
				        &nbsp;
<?
		}
		...
		{
?>
				        <a href="crc/delete-safety-audit.php?Id=<?= $iId ?>" onclick="return confirm('Are you SURE, You want to Delete this Audit?');"><img src="images/icons/delete.gif" width="16" height="16" alt="Delete" title="Delete" /></a>
				        &nbsp;
<?
		}
?>
				        <a href="crc/view-safety-audit.php?Id=<?= $iId ?>" class="lightview" rel="iframe" title="Safety Audit :: :: width: 900, height: 650"><img src="images/icons/view.gif" width="16" height="16" alt="View" title="View" /></a>
				      </td>
				    </tr>
<?
	}
