...
?>
  ...
  <script type="text/javascript" src="scripts/reports/portal-usuage-report.js"></script>
</head>
...
<!--  Body Section Starts Here  -->
	    <div id="Body">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr valign="top">
			  <td width="100%">
			    <h1>Portal Usage Report</h1>

			    <form name="frmSearch" id="frmSearch" method="get" action="reports/export-portal-usuage-report.php" class="frmOutline" onsubmit="checkDoubleSubmission( );">
				<h2>Portal Usuage Report</h2>
				...
				<table border="0" cellpadding="3" cellspacing="0" width="100%">
				  ...
				  <tr>
					...
					<td align="center">:</td>
				    <td><input type="text" name="ToDate" value="<?= date('Y-m-d') ?>" id="ToDate" readonly class="textbox" style="width:70px;"  onclick="displayCalendar($('ToDate'), 'yyyy-mm-dd', this);" /></td>
