...
<!--  Body Section Starts Here  -->
	    <div id="Body">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr valign="top">
			  <td width="100%">
			    <h1>Triumph report</h1>

			    <form name="frmSearch" id="frmSearch" method="post" action="<?= SITE_URL.'reports/export-triumph-report.php' ?>" class="frmOutline" onsubmit="checkDoubleSubmission( );">
				<h2>Triumph Report</h2>
				  ...
				  <tr>
					...
					<td>
					  <select name="Auditor" style="width:300px;">
						<option value=""></option>
<?
	if (!@in_array($_SESSION["UserType"], array("TRIPLETREE")))
