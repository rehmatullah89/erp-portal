<?
	...
	***********************************************************************************************
	...
	$FromDate = date("Y-m-01", mktime(0, 0, 0, (date("m") - 2), date("d"), date("Y")));
...
?>
  <script type="text/javascript" src="scripts/reports/kpis-report.js"></script>
</head>
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr valign="top">
			  <td width="100%">
			    ...
			    <form name="frmSearch" id="frmSearch" method="get" action="reports/export-kpis-report.php" class="frmOutline" onsubmit="checkDoubleSubmission( );">
				<h2>KPI's Report</h2>
...
?>
				  ...
				  <tr valign="top">
					<td>
					  Brands<br />
					  [ <a href="./" onclick="selectAll('Brands'); return false;">All</a> | <a href="./" onclick="clearAll('Brands'); return false;">None</a> ]<br />
					</td>

					<td align="center">:</td>

					<td>
					  <select name="Brands[]" id="Brands" size="10" multiple>
<?
	$sSQL = "SELECT id, brand FROM tbl_brands WHERE id IN ({$_SESSION['Brands']}) AND NOT FIND_IN_SET(id, '130,77,167') ORDER BY brand";
	$objDb->query($sSQL);
