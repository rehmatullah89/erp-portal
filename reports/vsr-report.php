...
?>
  <script type="text/javascript" src="scripts/reports/vsr-report.js"></script>
</head>
		  ...
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr valign="top">
			  <td width="100%">
			    ...
			    <form name="frmSearch" id="frmSearch" method="get" action="reports/export-vsr-report.php" class="frmOutline" onsubmit="checkDoubleSubmission( );">
				<h2>VSR Report</h2>

				<table border="0" cellpadding="3" cellspacing="0" width="100%">
				  <tr>
					<td width="60">Region<span class="mandatory">*</span></td>
					<td width="20" align="center">:</td>

					<td>
					  <select name="Region" id="Region" onchange="getVendorsList( );">
						<option value=""></option>
<?
...
?>
				  ...
				  <tr>
					...
					<td>
					  <select name="Category" id="Category" onchange="getVendorsList( );">
						<option value=""></option>
<?
...
?>
				  ...
				  <tr valign="top">
					...
					<td>
					  <select name="Vendor[]" id="Vendor" multiple size="10" style="min-width:200px;">
<?
...
?>
				  ...
				  <tr valign="top">
					...
					<td>
					  <select name="Brand[]" id="Brands" multiple size="10" style="min-width:200px;" onclick="getSeasonsList( );">
<?
...
?>
				  ...
				  <tr valign="top">
					...
					<td>
					  <select name="Season[]" id="Seasons" multiple size="10" style="min-width:200px;">
					  </select>
					</td>
				  </tr>
