			    ...
			    <div class="tblSheet">
				  <table border="0" cellpadding="0" cellspacing="0" width="100%">
				    <tr>
					  <td width="49%">
<?
	$sChartName  = "TopLevelEtdRevisions";
	$sChartTitle = "Top Level ETD Revision Classifications";
	$iChartLevel = 0;

	@include($sBaseDir."includes/vsr/etd-revisions.php");
?>
				      </td>
...
<?
	if ($Step >= 1)
	{
		$sChartName  = "MidLevelEtdRevisions";
		$sChartTitle = "Mid Level ETD Revision Classifications";
		$iChartLevel = 1;
...
<?
	if ($Step >= 2)
	{
		$sChartName  = "EtdRevisions";
		$sChartTitle = "ETD Revision Classifications";
		$iChartLevel = 2;
