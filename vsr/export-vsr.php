<?
	...
	***********************************************************************************************
	...
	$sSQL = "SELECT category_id, vendor, btx_division FROM tbl_vendors WHERE id=(SELECT vendor_id FROM tbl_po WHERE id IN ($POs) LIMIT 1) AND parent_id='0' AND sourcing='Y'";
	$objDb->query($sSQL);
...
//	if ($Format == "pdf")
//	{
//			@include($sBaseDir."includes/vsr/export-actual-btx-pdf-vsr.php");
/*
		if ($sBtxDivision == "Y" && $Type == "Actual")
			@include($sBaseDir."includes/vsr/export-actual-btx-pdf-vsr.php");

		else if ($Type == "Planned")
			@include($sBaseDir."includes/vsr/export-planned-pdf-vsr.php");

		else if ($Type == "Comparative")
			@include($sBaseDir."includes/vsr/export-comparative-pdf-vsr.php");

		else if ($Type == "Actual")
			@include($sBaseDir."includes/vsr/export-actual-pdf-vsr.php");
*/
//	}
...
//	{
		...
		if ($sBtxDivision == "Y" && $Type == "Actual")
			@include($sBaseDir."includes/vsr/export-actual-btx-xlsx-vsr.php");

		else if ($Type == "Planned" && ($iBrandId == 67 || $iBrandId == 75))
			@include($sBaseDir."includes/vsr/export-ar-planned-xlsx-vsr.php");

		else if ($Type == "Planned")
			@include($sBaseDir."includes/vsr/export-planned-xlsx-vsr.php");

		else if ($Type == "Comparative" && ($iBrandId == 67 || $iBrandId == 75))
			@include($sBaseDir."includes/vsr/export-ar-comparative-xlsx-vsr.php");

		else if ($Type == "Comparative")
			@include($sBaseDir."includes/vsr/export-comparative-xlsx-vsr.php");

		else if ($Type == "Actual" && ($iBrandId == 67 || $iBrandId == 75))
			@include($sBaseDir."includes/vsr/export-ar-actual-xlsx-vsr.php");

		else if ($Type == "Actual")
			@include($sBaseDir."includes/vsr/export-actual-xlsx-vsr.php");
